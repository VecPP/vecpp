...
TEST_CASE("simple vector rotate", "[quat]") {
  constexpr fVec3 u_x = {1.0f, 0.0f, 0.0f};
  constexpr fVec3 u_y = {0.0f, 1.0f, 0.0f};
  constexpr fVec3 u_z = {0.0f, 0.0f, 1.0f};

  constexpr fQuat r_x = fQuat::angle_axis(fAngle::from_deg(90.0f), u_x);
